                ...
                <?php
                    if(isset($_POST['submit'])){
                        ...
                        if(!in_array($type2, $tipe_diizinkan)){
                            ...
                            move_uploaded_file($tmp_name, './merk/'.$newname);

                            $insert = mysqli_query($conn, "INSERT INTO tb_merk VALUES (
                                        null,
                                        '".$merk."',
                                        '".$newname."',
                                            ) ");
                            ...
                            if($insert){
                                ...
                                echo '<script>window.location="data-merk.php"</scirpt>';
                            }else{
