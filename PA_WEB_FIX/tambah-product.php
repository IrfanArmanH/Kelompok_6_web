                    ...
                    <div class="container">
                        <div class="box-navbar">
                            ...
                            <ul class="menu">
                                ...
                                <li><a href="data-pesanks.php">Data Pesan</a></li>
        ...
        <div class="container">
            ...
            <div class="box">
                <form class="form-profil" action="" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="text" name="nama" class="input-control" placeholder="Nama Product" >
                    <input type="number" name="harga" min="0" oninput="validity.valid||(value='');" class="input-control" placeholder="Harga" required>
                    <input type="number" name="stok" min="0" oninput="validity.valid||(value='');" class="input-control" placeholder="Stok" required>
